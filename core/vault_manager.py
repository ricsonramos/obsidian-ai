...
class VaultManager:
        ...
        for file_path in md_files:
            try:
                with open(file_path, "r", encoding="utf-8") as f:
                    ...
                    # Também indexa pelo nome do arquivo (snake_case)
    ...
    def get_existing_notes(self) -> list[str]:
        """
        Retorna lista ordenada de títulos/slugs existentes para injetar
        no prompt como {existing_notes} e alimentar o Gap Logic.
        """
